...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="车导id">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入型号">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>区域：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="address" name="address" type="text" class="input-text" style="width: 100%;"
                           value="{{ isset($data->address) ? $data->address : '' }}" placeholder="请输入区域">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>座位数：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="seat" name="seat" type="text" class="input-text" style="width: 100%;"
                           value="{{ isset($data->seat) ? $data->seat : '' }}" placeholder="请输入座位数">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>车导图片：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="image" name="image" type="text" class="input-text"
                           value="{{ isset($data->image) ? $data->image : '' }}" placeholder="请选择车导图片">
                </div>
            </div>
            <div class="row cl">
        ...
        $(function () {
            ...
            $("#form-admin-add").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/madeTour/car/edit')}}",

...
@section('content')
    <div class="page-container">
        <form class="form form-horizontal" method="post" id="form-news-edit">
            {{csrf_field()}}
                ...
                <div class="row cl hidden">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input id="id" name="id" type="text" class="input-text"
                               value="{{ isset($data->id) ? $data->id : '' }}" placeholder="新闻id">
                    </div>
                </div>
                <div class="tabCon">
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="sort" name="sort" type="text" class="input-text"
                                   value="{{ isset($data['sort']) ? $data['sort'] : '' }}" placeholder="值越大越靠前">
                        </div>
                    </div>
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="title" name="title" type="text" class="input-text"
                                   value="{{ isset($data['title']) ? $data['title'] : '' }}" placeholder="请输入短标题">
                        </div>
                    </div>
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="content_image" name="content_image" type="text" class="input-text"
                                   value="{{ isset($data->content_image) ? $data->content_image : '' }}"
                                   placeholder="请选择内容图片（可以为空）">
                        </div>
                    </div>
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="drimecost" name="drimecost" type="text" class="input-text"
                                   value="{{ isset($data['drimecost']) ? $data['drimecost'] : '' }}"
                                   placeholder="请输入原价（默认）">
                        </div>
                    </div>
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="price" name="price" type="text" class="input-text"
                                   value="{{ isset($data['price']) ? $data['price'] : '' }}" placeholder="请输入实际价格（默认）">
                        </div>
                    </div>
                    <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="unit" name="unit" type="text" class="input-text"
                                   value="{{ isset($data['unit']) ? $data['unit'] : '' }}" placeholder="请输入单位">
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>共有位子（默认）：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="total" name="total" type="text" class="input-text"
                                   value="{{ isset($data['total']) ? $data['total'] : '' }}" placeholder="请输入共有位子（默认）">
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>剩余空位（默认）：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="surplus" name="surplus" type="text" class="input-text"
                                   value="{{ isset($data['surplus']) ? $data['surplus'] : '' }}"
                                   placeholder="请输入剩余空位（默认）">
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>出发地：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input id="start_place" name="start_place" type="text" class="input-text"
                                   value="{{ isset($data['start_place']) ? $data['start_place'] : '' }}"
                                   placeholder="请输入出发地">
                        </div>
                    </div>
                    <div class="row cl">
    ...
    <script id="prefix_graphic_content_template" type="text/x-dot-template">
        <div id="graphic_content_detail" class="formControls col-xs-12 col-sm-12">
            ...
            <textarea id="prefix_text_detail_@{{=it.index}}" wrap="\n" class="textarea" style="resize:vertical;"
                      placeholder="请填写内容" dragonfly="true" nullmsg="内容不能为空！">@{{=it.content}}</textarea>
            @{{?? it.type==1 }}
            <img src="@{{=it.content}}"/>
            @{{?? it.type==2 }}
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        //编辑详情
        //确认添加文本操作
        function submitDetailText(tour_goods_id) {
            ...
            if (add_text == '') {
                ...
                var detail = {};
                detail['tour_goods_id'] = tour_goods_id;
        ...
        //确认添加图片操作
        function submitDetailImage(tour_goods_id) {
        ...
        //确认添加视频操作
        function submitDetailVideo(tour_goods_id) {
            ...
            if (add_video == '') {
                ...
                addExampleDetailList(detail, function (ret) {
                    if (ret.result == true) {
                        ...
                        $('#' + config_graphic['prefix'] + 'videoPrv').attr('src', '')
                        $('#' + config_graphic['prefix'] + 'videoPrv').hide()
                        $('#' + config_graphic['prefix'] + 'imagePrv_video').show()
        ...
        function editExampleDetailList(jsonObj) {
            ...
            editTourGoodsDetails('{{URL::asset('')}}', param, function (ret) {
        ...
        function addExampleDetailList(detail, callBack) {
            console.log('detail_type:' + +JSON.stringify(detail['type']));
            if (detail['type'] == 0) {
                detail['content'] = transformationRow(detail['content'])
            }
            var param = {
                _token: "{{ csrf_token() }}",
                tour_goods_id: detail['tour_goods_id'],
                content: detail['content'],
                type: detail['type'],
                sort: detail['sort']
            }
            editTourGoodsDetails('{{URL::asset('')}}', param, callBack)
        }
            ...
            $(function () {
                ...
                $("#form-news-edit").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $(form).ajaxSubmit({
                            type: 'POST',
                            url: "{{ URL::asset('/admin/product/tourGoods/edit')}}",

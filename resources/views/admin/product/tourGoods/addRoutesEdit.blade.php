    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="place" name="place" type="number" class="input-text" style="width: 100%;"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="content" name="content" type="number" class="input-text" style="width: 100%;"
                           value="{{ isset($data->content) ? $data->content : '' }}" placeholder="请输入内容">
                </div>
            </div>
            <div class="row cl">

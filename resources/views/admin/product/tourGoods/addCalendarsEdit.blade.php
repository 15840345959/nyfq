    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="date" name="date" type="text" class="input-text" style="width: 100%;"
                           value="{{ isset($data->date) ? $data->date : '' }}" placeholder="请输入出发线路">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"></label>
                <div class="formControls col-xs-8 col-sm-9">
                    <p style="color: red;">日期格式：2017-12-20 </p>
                </div>
            </div>
            <div class="row cl">
        ...
        $(function () {
            ...
            $("#form-admin-add").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/product/tourGoods/editCalendars')}}",
